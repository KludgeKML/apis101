...
ActiveRecord::Schema[7.1].define(version: 2023_10_24_143416) do
  ...
  create_table "roles_groups", force: :cascade do |t|
    t.bigint "role_id", null: false
    t.bigint "group_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "groups_roles", "groups"
  add_foreign_key "groups_roles", "roles"
